                ...
                <div class="container" style="width:100vw">
                    ...
                    <div class="row">
                        <div class="col-md-12 ">
                            ...
                            @foreach ($facillities as $faci)

@php                  
$fac = \App\Facillity::where(['id' => $faci])->first();
$facid = $fac["id"];
@endphp
<button class="tablinks" onclick="openCity(event, 'fac{{$facid}}')" id="defaultOpen">{{$fac["title"]}}</button>
@endforeach
</div>
                  
                            <div class="sectiontable">
     
                            @foreach ($facillities as $facility)

         
                                <div class='pricing pricing-palden' id='fac{{$facility}}'>
                   
            
                
                                    @foreach ($days[$facility] as $day=>$types)
                                    <?php
...
function openCity(evt, cityName) {
  ...
  tabcontent = document.getElementsByClassName("pricing-palden");
