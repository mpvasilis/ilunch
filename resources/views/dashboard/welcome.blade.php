                            ...
                            <div class="panel-body">
                                <ul class="list-group">
                                    ...
                                    @foreach($menuprwino as $prwino)
                                        <a data-toggle="modal" data-target="#myModal" class="openmodal"
                                           data-title="{{$prwino->title}}" data-details="{{$prwino->info}}">
                                            <li class="list-group-item">{{$prwino->title}}</li>
                                        </a>
                                    @endforeach
                                </ul>
                            ...
                            <div class="panel-body">
                                <ul class="list-group">
                                    @foreach($menumeshmeriano as $meshmeriano)
                                        ...
                                        <a data-toggle="modal" data-target="#myModal" class="openmodal"
                                           data-title="{{$meshmeriano->title}}" data-details="{{$meshmeriano->info}}">
                                            <li class="list-group-item">{{$meshmeriano->title}}</li>
                                        </a>
                                    @endforeach
                                </ul>
                            </div>
                            ...
                            <div class="panel-body">
                                <ul class="list-group">
                                    @foreach($menuvradino as $vradino)
                                        <a data-toggle="modal" data-target="#myModal" class="openmodal"
                                           data-title="{{$vradino->title}}" data-details="{{$vradino->info}}">
                                            <li class="list-group-item">{{$vradino->title}}</li>
                                        </a>
                                    @endforeach
                                </ul>
                            </div>
