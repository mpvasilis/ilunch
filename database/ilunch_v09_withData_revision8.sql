...
-- Χρόνος δημιουργίας: 02 Μάη 2019 στις 18:35:01
-- Έκδοση διακομιστή: 10.0.38-MariaDB
-- Έκδοση PHP: 7.2.7
...
(36, 'Καλή μας Αρχή', 'Το νέο website της επιτροπής σίτισης του Πανεπιστήμιου Δυτικής Μακεδονίας είναι γεγονός!', '2019-05-04', '2019-02-17', '2019-05-02', 2, '1'),
(37, 'Δωρεάν Γεύματα', 'Δωρεάν Γεύματα μέχρι τις 5 Μαΐου!', '2019-05-05', '2019-05-02', '2019-05-02', 1, '0');
...
(1, 'Student Restaurant 1', 'Student Restaurant 1', 1, '2019-04-10 00:00:00'),
(2, 'Student Restaurant 2', 'Student Restaurant 2', 1, '2019-04-21 17:50:31');

-- --------------------------------------------------------

--
-- Δομή πίνακα για τον πίνακα `meal_votes`
--
...
--
-- Άδειασμα δεδομένων του πίνακα `meal_votes`
--

INSERT INTO `meal_votes` (`id`, `meal_id`, `stars`, `date`, `created_at`) VALUES
(1, 15, 5, '2019-04-02 00:00:00', '2019-04-10 00:00:00'),
(2, 67, 5, '2019-04-29 13:14:29', '2019-04-29 13:14:29'),
(3, 70, 4, '2019-04-29 13:14:53', '2019-04-29 13:14:53'),
(4, 71, 4, '2019-04-29 13:14:57', '2019-04-29 13:14:57'),
(5, 94, 5, '2019-04-29 13:21:13', '2019-04-29 13:21:13'),
(6, 96, 1, '2019-04-29 13:21:19', '2019-04-29 13:21:19'),
(7, 99, 5, '2019-04-29 13:21:23', '2019-04-29 13:21:23'),
(8, 69, 5, '2019-04-29 13:21:28', '2019-04-29 13:21:28'),
(9, 68, 5, '2019-04-29 13:21:32', '2019-04-29 13:21:32'),
(10, 68, 1, '2019-04-29 13:21:36', '2019-04-29 13:21:36'),
(11, 68, 1, '2019-04-29 13:25:09', '2019-04-29 13:25:09'),
(12, 68, 5, '2019-04-29 15:40:58', '2019-04-29 15:40:58'),
(13, 66, 4, '2019-04-29 15:41:06', '2019-04-29 15:41:06');
...
(104, 'Χοιρινή τηγανιά', NULL, 1, '2019-05-02', '2019-05-02'),
(105, 'Χοιρινή τηγανιά', NULL, 1, '2019-05-02', '2019-05-02');
...
INSERT INTO `ratings` (`id`, `schedule_id`, `rating`, `comment`, `student_id`, `station_id`, `created_at`, `filename`) VALUES
(1, NULL, 4, 'Test', 3, 0, '2019-05-02 14:27:17', '[]'),
(2, 0, 5, 'To φαγητό ήταν τέλειο!', 0, 0, '2019-05-02 14:39:13', '[\"ee1e8ec9439c569678ee358aef5b1379_pexels-photo-461198.jpeg\"]'),
(3, NULL, 5, 'Ωραιό φαγητό σήμερα....', 3, 0, '2019-05-02 14:47:40', '[\"664989ef841cbcc597ec25f80050245c_pexels-photo-461198.jpeg\"]');
...
(1, 'Feedback Station 1', 'Feedback Station 1', 1, '2019-04-23 20:17:59');
...
(1, 2, 123, 1, 1, 5, '2019-05-02 15:33:05'),
(2, 2, 124, 1, 1, 1, '2019-05-02 15:33:08'),
(3, 2, 125, 1, 1, 1, '2019-05-02 15:33:09'),
(4, 2, 126, 1, 1, 5, '2019-05-02 15:33:12');
...
(2, 1069, 'Christos', 'Sarantis', 'Dimitrios', 'c81e728d9d4c2f636f067f89cc14862c.jpg', 1, 6, '2018-04-09 21:00:00'),
(3, 1041, 'Vasileios', 'Balafas', 'Konstantinos', '10e3634a31e25b235bb5e50a1b4b1245.jpeg', 1, 8, '2019-05-02 14:53:50');
...
(1, 'Vasilis Balafas', 'me@vasilis.pw', '$2y$10$McF4Y8IKTQMmFrpqNjv6FeJkv06DO4rC6RA.j8pf3vm1EOE8gjIOa', 'uke8F4g2eWJgKEd3nJ27Xdo0wPIDKCn8BwMGKuGVN8FTg3mXduNldMDlzewD', 'ADMINISTRATOR', 1041, '2017-03-28 01:49:24', '2019-01-27 11:22:10'),
(2, 'Facility Staff', 'ilunch_staff@vasilis.pw', '$2y$10$McF4Y8IKTQMmFrpqNjv6FeJkv06DO4rC6RA.j8pf3vm1EOE8gjIOa', 'gJ02HpBS1HEZ2k9jFBEM0iZLDr0isorHZooPHYtxBy69UMtXs5EEDYq7jqcU', 'ADMINISTRATOR', 718, '2017-04-01 11:29:08', '2017-04-01 11:29:08');
...
--
-- Ευρετήρια για πίνακα `meal_votes`
--
...
--
-- AUTO_INCREMENT για πίνακα `meal_votes`
--
ALTER TABLE `meal_votes`
