...
-- Χρόνος δημιουργίας: 02 Απρ 2017 στις 22:44:15
...
INSERT INTO `announcements` (`id`, `title`, `content`, `show_until`, `created_at`, `created_by`, `type`) VALUES
(7, 'Δωρεάν φαγητό μέχρι τις 19.30 !', 'Δωρεάν φαγητό μέχρι τις 19.30, εξαιτίας μικρής ζήτησης', '2017-04-04', '2017-04-05', 1, 'success'),
(8, 'Δωρεάν φαγητό μέχρι ', 'Δωρεάν φαγητό μέχρι τις 19.30, εξαιτίας μικρής ζήτησης', '2017-04-04', '2017-04-05', 1, 'success'),
(9, 'Δωρεάν φαγητό μέχρι 2223', 'Δωρεάν φαγητό μέχρι τις 19.30, εξαιτίας μικρής ζήτησης', '2017-04-04', '2017-04-05', 1, 'success');
...
INSERT INTO `menu_meals` (`id`, `title`, `info`, `is_active`, `type_id`) VALUES
(1, 'Αυγά Βραστά', 'δφδσφφδσ', 1, 1),
(2, 'Παστιτσιο', 'σφδσφ', 1, 2),
(3, 'μακαρόνια', 'φδσφσδ', 1, 3);
