...
-- Χρόνος δημιουργίας: 21 Απρ 2018 στις 16:16:18
...
--
CREATE DATABASE IF NOT EXISTS `ilunch` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `ilunch`;
...
(32, 'Δωρεάν Φαγητό μέχρι τις 122', 'Θα υπάρχει δωρεάν φαγητό', '2018-04-18', '2018-04-17', '2018-04-17', NULL, '2'),
(33, 'Δωρεάν Φαγητό μέχρι τις 12', 'Θα υπάρχει δωρεάν φαγητό', '2018-04-18', '2018-04-17', '2018-04-17', NULL, '2');
...
(0x31, 'sdsd', 1, 1, 0, 1, '2018-04-09', 1, 1);
...
INSERT INTO `membership_types` (`id`, `title`, `type`, `value`, `expires`) VALUES
(0, '????', '????', 50, '2018-04-02'),
(1, '????', '????', 50, '2018-04-02');
...
INSERT INTO `students` (`id`, `AM`, `AEM`, `fistname`, `lastname`, `father_name`, `photo`, `department_id`, `semester`, `created_at`) VALUES
(1, 21, 155, 'Alex', 'Modis', 'Modis', '/images/default.png', 1, 1, '2018-04-10'),
(2, 21, 155, 'Alex', '', 'Modis', '/images/default.png', 1, 1, '2018-04-10');
...
--
-- AUTO_INCREMENT για πίνακα `history`
--
ALTER TABLE `history`
