...
INSERT INTO `menus` (`id`, `day`, `week`, `day_start`, `day_end`, `type_id`) VALUES
...
INSERT INTO `menu_assigns` (`id`, `meal_id`, `menu_id`) VALUES
(1, 1, 1),
(2, 2, 1),
(3, 3, 1);
...
(1, 'Αυγά Βραστά', 'δφδσφφδσ', 1, '0000-00-00', '0000-00-00'),
(2, 'Παστιτσιο', 'σφδσφ', 1, '0000-00-00', '0000-00-00'),
(3, 'μακαρόνια', 'φδσφσδ', 1, '0000-00-00', '0000-00-00'),
(4, 'dsffds', 'fdssd', 0, '2018-04-16', '2018-04-16'),
...
INSERT INTO `ratings` (`id`, `menu_id`, `rating`, `comment`, `student_id`, `created_at`) VALUES
...
INSERT INTO `statistics` (`id`, `student_id`, `menu_id`, `membership_id`, `created_at`) VALUES
(1, 2, 1, 4, '2018-06-19 10:19:02'),
(2, 2, 1, 1, '2018-06-19 10:19:02');
...
(1, 'Sarantis', 'i@sarantis.pw', '$2y$10$AF1p0HaulDq.nFLJ0Q2Oc.P5oJfEvz2VqOEu4I69DUl2/ms1wp8/G', 'uke8F4g2eWJgKEd3nJ27Xdo0wPIDKCn8BwMGKuGVN8FTg3mXduNldMDlzewD', 'ADMINISTRATOR', 1069, '2017-03-28 01:49:24', '2017-03-28 01:49:24'),
