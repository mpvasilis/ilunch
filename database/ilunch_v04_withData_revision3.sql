...
-- Χρόνος δημιουργίας: 16 Φεβ 2019 στις 01:45:27
...
(2, 'Clara Bella', 2, 1, 1, 1, '2018-06-18 22:29:16', 1, 0),
...
INSERT INTO `menus` (`id`, `day`, `week`) VALUES
(1, 1, 1),
(4, 6, 1),
(5, 2, 1);
...
(2, 'Παστιτσιο', 'σφδσφ', 1, '0000-00-00', '0000-00-00'),
(3, 'μακαρόνια', 'φδσφσδ', 1, '0000-00-00', '0000-00-00'),
(5, 'dsaads', 'dsffdsdsf', 0, '2018-04-16', '2018-04-16'),
(65, 'dsffds', 'fdssd', 0, '2018-04-16', '2018-04-16');
...
INSERT INTO `ratings` (`id`, `schedule_id`, `rating`, `comment`, `student_id`, `created_at`) VALUES
(1, 1, 4, NULL, 2, '2018-06-19 10:07:55');
...
INSERT INTO `statistics` (`id`, `student_id`, `schedule_id`, `type_id`, `membership_id`, `created_at`) VALUES
(2, 1, 29, 1, 1, '2019-02-15 22:43:56');
...
(1, 718, 'Alex', 'Modis', 'Modis', 'assets/images/profilePlaceholder.jpg	', 1, 1, '2018-04-09 21:00:00'),
(2, 1069, 'Christos', 'Sarantis', 'Dimitrios', 'c81e728d9d4c2f636f067f89cc14862c.jpeg', 1, 6, '2018-04-09 21:00:00'),
(3, 1039, 'Παναγιώτης', 'Μπάκας', 'Αθανάσιος', 'assets/images/profilePlaceholder.jpg', 1, 6, '2018-06-19 09:25:14'),
(4, 1043, 'Κατερίνα', 'Μπαντόλα', 'Στέλιος', 'assets/images/profilePlaceholder.jpg', 1, 6, '2018-06-19 09:26:16'),
(5, 715, 'ΑΛΕΞΑΝΔΡΟΣ ΜΟΔΕΣΤΟΣ', 'ΜΟΔΗΣ', NULL, 'assets/images/profilePlaceholder.jpg', NULL, 11, '2018-12-29 17:37:15'),
(6, 1041, 'ΒΑΣΙΛΕΙΟΣ', 'ΜΠΑΛΑΦΑΣ', NULL, 'assets/images/profilePlaceholder.jpg', NULL, 7, '2018-12-29 17:37:27');
...
(2, 'Alex', 'modis.alex@gmail.com', '$2y$10$FHJ8J0FEKWAnYjQ62ObCtOIPqmLWl/8tVLAQbRsoFuxZMMgH3Yo4y', 'J7mBswrivVUKVvyf0GDJWkFvXYLI76CecWnk5ybrRa0QNxcEGkBTZaheX1IC', 'ADMINISTRATOR', 718, '2017-04-01 11:29:08', '2017-04-01 11:29:08'),
...
(5, 'DrSpawn', 'cs.drspawn@gmail.com', '$2y$10$IKqpM.K1uAZioH3JCMEvyuNOW.irYLROVuCOeJWY17A97yh7B53Bq', NULL, 'STUDENT', NULL, '2018-06-19 07:37:53', '2018-06-19 07:37:53'),
(6, 'ΑΛΕΞΑΝΔΡΟΣ ΜΟΔΕΣΤΟΣ ΜΟΔΗΣ', 'st0718@icte.uowm.gr', 'toBeReset', 'zkE2n536b6U9h3qhaCqlepA1x6JLanhtoxPr6kT0JownCKv3mxofkehxtXYN', 'STUDENT', 718, '2018-12-29 15:37:14', '2018-12-29 15:37:14'),
(7, 'ΒΑΣΙΛΕΙΟΣ ΜΠΑΛΑΦΑΣ', 'st1041@icte.uowm.gr', 'toBeReset', 'RAonwasJgVc34KOjKb8SuX9B4aACM6NB6YgRbTSkbQ7jyfdGZbPOtEDjMVtf', 'STUDENT', 1041, '2018-12-29 15:37:26', '2018-12-29 15:37:26');
